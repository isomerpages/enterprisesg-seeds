...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/huangxiaowen/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
    ...
    <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 10px; padding: 10px; padding-left: 0;" class="sgds-card-content">
        <div>
            <p style="margin: 0; text-align: left;"><strong>Huang Xiao Wen</strong></p>
            <small style="text-align: left;">Senior Investment Manager</small>
        </div>
    </div>
</div>
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/clementchua/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/lohwz/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/foohuishi/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/limmiaowen/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/ryansoh/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/dannychiam/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div class="sgds-card col" style="flex: 1 1 47%; margin: 10px; max-width: 300px;">
    <a href="https://www.linkedin.com/in/limjiahui/" target="_blank">
        <div class="sgds-card-image" style="width: 100%;">
            <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
...
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin: 10px;">
    ...
    <div class="sgds-card col" style="max-width: 300px;">
        <a href="https://www.linkedin.com/in/derekneo/" target="_blank">
            <div class="sgds-card-image" style="width: 100%;">
                <figure class="sgds-image" style="margin: 0; height: 350px; width: 100%;">
                    <img src="/images/Profile Photos/Derek_NEO.png" style="width: 100%; height: 100%; object-fit: contain; border-radius: 5px;">
                </figure>
            </div>
        </a>
        <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 5px; padding: 0 10px;" class="sgds-card-content">
