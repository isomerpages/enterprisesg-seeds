...
sections:
  ...
  - infobar:
      description: <div class="row justify-content-between padding--bottom"><div class="col force-half padding"><img src="/images/Quotation-Symbol-PNG.png" alt="Image alt text"></div><div class="col force-half has-text-left"><img src="/images/Quotation-Symbol-PNG.png" style="width: 100px;display: block;"><small class="" style="width: 100px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris elementum eget arcu vehicula malesuada. Etiam eros mauris, tempus quis augue id, ultrices porta turpis. Integer eu nunc risus. Phasellus pellentesque velit sed enim efficitur lacinia. In finibus, augue sodales dapibus commodo, neque purus laoreet odio, eget vulputate turpis risus in orci. Nulla facilisi. Sed in tellus rhoncus, scelerisque quam eget, accumsan nisi.</small><h2 class="has-text-secondary margin--top"><b>Jane Doe</b></h2><p class="padding--bottom eyebrow is-uppercase">General Partner</p></div></div>
  - infobar:
